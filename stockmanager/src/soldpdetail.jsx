...
import Main from "./main";
    ...
    class Soldpdetail extends Component{
        constructor(props) {
          super(props);
   ...
   render()
   {
     ...
     const filtered= this.state.persons.filter(person =>{
       return person.product_name.toLowerCase().indexOf( search.toLowerCase()) !== -1 ||  person.sno.toLowerCase().indexOf( search.toLowerCase()) !== -1 ||  person.date >= search
     })
     var total=0;
